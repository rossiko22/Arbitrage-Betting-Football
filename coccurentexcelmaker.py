...
with open("/home/marko/Desktop/arbitragepy/leagues/leagues.txt", "r") as f:
    leagues = json.load(f)

for i in leagues:
    file_path = f"/home/marko/Desktop/arbitragepy/datatxt/{i}.txt"
    print(i)
    try:     
    ...
    output_file = f"/home/marko/Desktop/arbitragepy/dataxlsx/{i}.xlsx"
...
# # Load the list of leagues from the file
# with open("/home/marko/Desktop/arbitragepy/leagues/leagues.txt", "r") as file:
#     text_files = json.load(file)

# for i in range(len(text_files)):
#     file_path = f"/home/marko/Desktop/arbitragepy/datatxt/{text_files[i]}.txt"
